 ...
 */
var MorphaAnnotator = function (_Annotator) {
  _inherits(MorphaAnnotator, _Annotator);

  /**
   * Create an Annotator
   * @param {Object} [options] a key-value map of options, without the annotator prefix
   */
  function MorphaAnnotator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, MorphaAnnotator);

    return _possibleConstructorReturn(this, (MorphaAnnotator.__proto__ || Object.getPrototypeOf(MorphaAnnotator)).call(this, 'lemma', _extends({}, options), [new _tokenize2.default(), new _ssplit2.default(), new _pos2.default()]));
  }

  return MorphaAnnotator;
}(_annotator2.default);
