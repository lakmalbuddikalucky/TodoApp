 ...
 */
var POSTaggerAnnotator = function (_Annotator) {
  _inherits(POSTaggerAnnotator, _Annotator);

  /**
   * Create an Annotator
   * @param {Object} [options] a key-value map of options, without the annotator prefix
   */
  function POSTaggerAnnotator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, POSTaggerAnnotator);

    return _possibleConstructorReturn(this, (POSTaggerAnnotator.__proto__ || Object.getPrototypeOf(POSTaggerAnnotator)).call(this, 'pos', _extends({}, options), [new _tokenize2.default(), new _ssplit2.default()]));
  }

  return POSTaggerAnnotator;
}(_annotator2.default);
