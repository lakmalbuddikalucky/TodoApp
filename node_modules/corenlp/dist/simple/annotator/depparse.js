 ...
 */
var DependencyParseAnnotator = function (_Annotator) {
  _inherits(DependencyParseAnnotator, _Annotator);

  /**
   * Create an Annotator
   * @param {Object} [options] a key-value map of options, without the annotator prefix
   */
  function DependencyParseAnnotator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, DependencyParseAnnotator);

    return _possibleConstructorReturn(this, (DependencyParseAnnotator.__proto__ || Object.getPrototypeOf(DependencyParseAnnotator)).call(this, 'depparse', _extends({}, options), [new _tokenize2.default(), new _ssplit2.default(), new _pos2.default()]));
  }

  return DependencyParseAnnotator;
}(_annotator2.default);
