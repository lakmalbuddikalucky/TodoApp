 ...
 */
var ParserAnnotator = function (_Annotator) {
  _inherits(ParserAnnotator, _Annotator);

  /**
   * Create an Annotator
   * @param {Object} [options] a key-value map of options, without the annotator prefix
   */
  function ParserAnnotator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, ParserAnnotator);

    return _possibleConstructorReturn(this, (ParserAnnotator.__proto__ || Object.getPrototypeOf(ParserAnnotator)).call(this, 'parse', _extends({}, options), [new _tokenize2.default(), new _ssplit2.default()]));
  }

  return ParserAnnotator;
}(_annotator2.default);
