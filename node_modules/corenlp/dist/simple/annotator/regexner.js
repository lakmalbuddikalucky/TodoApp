 ...
 */
var RegexNERAnnotator = function (_Annotator) {
  _inherits(RegexNERAnnotator, _Annotator);

  /**
   * Create an Annotator
   * @param {Object} [options] a key-value map of options, without the annotator prefix
   */
  function RegexNERAnnotator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, RegexNERAnnotator);

    return _possibleConstructorReturn(this, (RegexNERAnnotator.__proto__ || Object.getPrototypeOf(RegexNERAnnotator)).call(this, 'regexner', _extends({
