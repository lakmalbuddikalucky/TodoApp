 ...
 */
var RelationExtractorAnnotator = function (_Annotator) {
  _inherits(RelationExtractorAnnotator, _Annotator);

  /**
   * Create an Annotator
   * @param {Object} [options] a key-value map of options, without the annotator prefix
   */
  function RelationExtractorAnnotator() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, RelationExtractorAnnotator);

    return _possibleConstructorReturn(this, (RelationExtractorAnnotator.__proto__ || Object.getPrototypeOf(RelationExtractorAnnotator)).call(this, 'relation', _extends({}, options), [new _tokenize2.default(), new _ssplit2.default(), new _pos2.default(), new _lemma2.default(), new _ner2.default(), new _depparse2.default()]));
  }

  return RelationExtractorAnnotator;
}(_annotator2.default);
